...
describe("GitHubEvents.DeploymentStatus fixtures", function() {
  ...
  describe("pending", () => it("knows the state, description and repo", function() {
  ...
  describe("failure", () => it("knows the state, description and repo", function() {
  ...
  return describe("success", () => it("knows the state, description and repo", function() {
